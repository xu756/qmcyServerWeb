...
func (c *userClient) GetUserInfo(ctx context.Context, in *UserInfoRequest, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (UnimplementedUserServer) GetUserInfo(context.Context, *UserInfoRequest) (*UserInfo, error) {
